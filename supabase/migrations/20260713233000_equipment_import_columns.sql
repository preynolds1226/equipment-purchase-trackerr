...
add column if not exists last_service_mileage numeric,
add column if not exists parts_ordered text;

create index if not exists equipment_prefix_number_idx on public.equipment(lower(prefix), lower(unit_number));
create index if not exists equipment_make_model_idx on public.equipment(lower(make), lower(model));
create index if not exists equipment_serial_number_idx on public.equipment(lower(serial_number));
